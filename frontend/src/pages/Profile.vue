            ...
            <form @submit.prevent="changePassword" class="space-y-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input v-model="pwForm.new_password" type="password" required class="form-input" placeholder="Min. 6 characters" minlength="6" />
                </div>
                <div>
                  <label class="block text-xs font-medium text-gray-500 mb-1.5">Confirm Password</label>
                  <input v-model="pwForm.confirm" type="password" required class="form-input" :class="pwForm.confirm && pwForm.confirm !== pwForm.new_password ? 'border-red-400' : ''" placeholder="Re-enter password" />
