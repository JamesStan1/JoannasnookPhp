          ...
          <div class="px-6 py-5">
            ...
            <form @submit.prevent="submitPasswordReset" class="space-y-4">
              <div>
                ...
                <div class="relative">
                  <input v-model="newPassword" :type="showNewPw ? 'text' : 'password'" required autocomplete="new-password"
                    class="w-full px-4 py-2.5 pr-11 border-2 border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              ...
              <div>
                ...
                <div class="relative">
                  <input v-model="confirmPassword" :type="showConfirmPw ? 'text' : 'password'" required autocomplete="new-password"
                    class="w-full px-4 py-2.5 pr-11 border-2 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
